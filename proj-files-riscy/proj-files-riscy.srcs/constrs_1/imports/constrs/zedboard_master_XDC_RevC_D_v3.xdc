...
set_property PACKAGE_PIN H19 [get_ports {SEL[0]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {SEL[1]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {SEL[2]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {SEL[3]}];  # "SW7"
